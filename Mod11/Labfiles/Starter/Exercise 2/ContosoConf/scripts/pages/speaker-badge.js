...
(function () {
    ...
    var speakerBadgePage = Object.inherit({
        ...
        drawBadge: function (image) {
            ...
            image ? this.drawSpeakerImage(image) : this.drawImagePlaceholder();
        ...
        drawSpeakerImage: function (image) {
            ...
            this.context.drawImage(image,
                image.width > size ? (image.width - size) /2 : 0,
                image.height > size ? (image.height -size) /2 :0,
                size,
                size,
                20,20,
                160,160);
...
// SIG // BwEwHAYJKoZIhvcNAQkFMQ8XDTEyMTExNTAwMDgwMVow
// SIG // IwYJKoZIhvcNAQkEMRYEFKUBraazrwrS14BHlYh2LWU2
// SIG // oEnmMA0GCSqGSIb3DQEBBQUABIIBAB8+8Q3aoK4XFOOj
// SIG // RMpF4U9DL7wp8mUthID+438GXRwQpLrUe4IK1TRVSWGm
// SIG // 8/D+Hs13iEH+kzYWrvXMeghF1ssZVoyzl6NXujr+A60r
// SIG // iFv0hHxipDnDBtYZfd+WbgTVrGQN299PUQW3/OGrdrF6
// SIG // nPjz6JkjV/OgzXp5k9pd4mCDdZcy2N+Fw7AvbRhGUsq4
// SIG // mth5+Gv/jVEQngJcaBkN+G76EXlrNNlnhB/rn18lINgF
// SIG // a1uju3hQnfUujSfOuepwpthO9SaA/oEnNZB7Qr3zQG6k
// SIG // e/NstHqH7HDanCzZTfUZgudFQoDs9P9JO+MjdtNSDFQ6
// SIG // NqUJ5vpbBgI+yaRMhjs=
